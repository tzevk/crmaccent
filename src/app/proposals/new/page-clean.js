            ...
            <div className="form-column">
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows="3"
                  placeholder="Delivery schedule and milestones"
                ></textarea>
              </div>
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows="3"
                  placeholder="Compliance requirements and standards"
                ></textarea>
              </div>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  placeholder="Comma-separated reviewer names"
                />
              </div>
