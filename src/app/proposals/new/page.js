...
export default function CreateProposalPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const requiredFields = ['proposalId', 'proposalTitle', 'proposalDate', 'clientName', 'contactPerson', 'email', 'projectName', 'scopeOfWork', 'currentStatus'];
      ...
      const proposalData = {
        ...formData,
        created_by: user?.email || user?.username || 'Unknown User'
      };
      ...
      alert(`Error creating proposal: ${error.message}. Please try again.`);
    }
  };
