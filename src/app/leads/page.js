...
export default function LeadsPage() {
  ...
  // Lead to Proposal Conversion Handlers
  const handleConvertLead = (lead) => {
    setSelectedLead(lead);
    setShowConverter(true);
  };

  const handleConversionSuccess = (proposal, leadId) => {
    alert(`Lead successfully converted to proposal: ${proposal.proposal_title}`);
    setShowConverter(false);
    setSelectedLead(null);
    fetchLeads(); // Refresh leads to update status
    // Redirect to proposals page to view the new proposal
    setTimeout(() => {
  ...
  return (
    <div className="leads-page">
                      ...
                      <tr key={lead.id}>
                        ...
                        <td>
                          <div className="action-buttons">
                            ...
                            {lead.enquiry_status !== 'converted' && lead.enquiry_status !== 'lost' && (
                              <button 
                                className="btn-icon btn-convert"
                                title="Convert Lead to Proposal"
      ...
      {/* Lead to Proposal Converter Modal */}
      {showConverter && selectedLead && (
        <div className="modal-overlay">
          <div className="modal-content converter-modal">
            <LeadToProposalConverter
              lead={selectedLead}
